...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_list_limited_to_user(self):
        """
        Test the list of recipes is limited to the current user.
        """
    ...
    def test_create_recipe(self):
        ...
        # Check the creating action itself.
        res = self.client.post(RECIPES_URL, payload)
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)

        # Check the changes of the database.
    ...
    def test_update_other_user_recipe_error(self):
        """Test updating other users' recipe gives error."""
    ...
    def test_update_user_returns_error(self):
        """Test that changing the recipe user returns error."""
        new_user = create_user(
            email="newuser@example.com",
            password="awesomepassword123",
        )
        ...
        recipe.refresh_from_db()
        self.assertEqual(recipe.user, self.user)
        # Note that status code is still 200
        self.assertEqual(res.status_code, status.HTTP_200_OK)
    ...
    def test_create_tag_on_update(self):
        ...
        # Many to many fields, no need to refresh
    ...
    def test_create_recipe_with_existing_ingredients(self):
        """Test creating recipes with existing ingredients."""
    ...
    def test_create_ingredient_on_update(self):
        """Test creating an ingredient when updating recipes."""
        recipe = create_recipe(user=self.user)
    ...
    def test_clear_recipe_ingredients(self):
        """Test creating a recipe's ingredients."""
        ingredient = Ingredient.objects.create(
            user=self.user,
            name="Garlic"
        )
